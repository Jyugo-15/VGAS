...
point** is `data/libero/hflibero_fewshot_dataset_pipeline.sh`, which produces a 5-shot
...
- `MAPPING_JSON`: suite mapping (default: `data/libero/libero_tasksuit_info/libero_task_suites.json`)
...
```bash
python data/libero/split_hflibero_by_suite.py \
...
```bash
python data/libero/split_hflibero_few_shot.py \
