...
MAPPING_JSON="${MAPPING_JSON:-$REPO_ROOT/data/libero/libero_tasksuit_info/libero_task_suites.json}"
...
"$PYTHON_BIN" data/libero/split_hflibero_few_shot.py \
...
"$PYTHON_BIN" data/libero/split_hflibero_by_suite.py \
  --dataset-root "$OUT_ROOT/merge" \
  --mapping-json "$MAPPING_JSON" \
