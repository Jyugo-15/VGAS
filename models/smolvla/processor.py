...
try:
    # Prefer the upstream implementation if it is already available.
    from lerobot.policies.smolvla.processor_smolvla import SmolVLANewLineProcessor as _ExternalSmolVLANewLineProcessor
except Exception:
    _ExternalSmolVLANewLineProcessor = None
...
if _ExternalSmolVLANewLineProcessor is not None:
    SmolVLANewLineProcessor = _ExternalSmolVLANewLineProcessor
elif "smolvla_new_line_processor" in ProcessorStepRegistry.list():
    SmolVLANewLineProcessor = ProcessorStepRegistry.get("smolvla_new_line_processor")
else:
